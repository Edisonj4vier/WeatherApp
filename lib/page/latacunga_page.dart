...
class LatacungaPage extends StatefulWidget {
  const LatacungaPage({super.key});

  @override
  State<LatacungaPage> createState() => _LatacungaPageState();
}

class _LatacungaPageState extends State<LatacungaPage> {
  TextEditingController _cityController = TextEditingController();
  final Constants _constants = Constants();
  static String API_KEY = "b3452c29b787422daee190616231602";
  String location = "Latacunga";
